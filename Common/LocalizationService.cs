...
namespace VocabTrainer.Common
{
    ...
    public class LocalizationService : INotifyPropertyChanged
    {
        ...
        private static readonly Dictionary<string, string> _en = new()
        {
            ...
            [Strings.Training_FilterLabel]     = "Filter by category",
            [Strings.Training_FilterSearch]    = "Search tags...",
            [Strings.Training_FilterSelected]  = "Selected",
            [Strings.Training_FilterAll]       = "All tags",
            [Strings.Training_FilterFound]     = "Found words:",
            [Strings.Training_FilterNone]      = "No tags in dictionary",
            [Strings.Training_LangLabel]       = "Languages",
            [Strings.Training_QuestionLang]    = "Question",
            [Strings.Training_AnswerLang]      = "Answer",
            [Strings.Training_FlashcardDesc]   = "Show & reveal",
            [Strings.Training_MultiChoiceDesc] = "Pick the right answer",
            [Strings.Training_TextInputDesc]   = "Type the translation",
            [Strings.Training_MixedDesc]       = "Random each card",
        ...
        private static readonly Dictionary<string, string> _uk = new()
        {
            ...
            [Strings.Training_FilterLabel]     = "Фільтр за категорією",
            [Strings.Training_FilterSearch]    = "Пошук тегів...",
            [Strings.Training_FilterSelected]  = "Обрані",
            [Strings.Training_FilterAll]       = "Всі теги",
            [Strings.Training_FilterFound]     = "Знайдено слів:",
            [Strings.Training_FilterNone]      = "Немає тегів у словнику",
            [Strings.Training_LangLabel]       = "Мови",
            [Strings.Training_QuestionLang]    = "Питання",
            [Strings.Training_AnswerLang]      = "Відповідь",
            [Strings.Training_FlashcardDesc]   = "Показати та розкрити",
            [Strings.Training_MultiChoiceDesc] = "Обери правильну відповідь",
            [Strings.Training_TextInputDesc]   = "Введи переклад",
            [Strings.Training_MixedDesc]       = "Випадковий режим",
